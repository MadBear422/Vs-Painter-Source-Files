		...
		switch(SONG.stage)
		{
			...
			case 'stage':
				...
				case 'art':
				{
						defaultCamZoom = 0.7;
						curStage = 'art';
						var bg:FlxSprite = new FlxSprite(-600, -200).loadGraphic(Paths.image('painterback'));
						bg.antialiasing = true;
						bg.scrollFactor.set(0.9, 0.9);
						bg.active = false;
						add(bg);

						var painting:FlxSprite = new FlxSprite(130, -150).loadGraphic(Paths.image('painting'));
						...
						var stageFront:FlxSprite = new FlxSprite(-570, 600).loadGraphic(Paths.image('artground'));
						stageFront.setGraphicSize(Std.int(stageFront.width * 1.1));
						stageFront.updateHitbox();
						stageFront.antialiasing = true;
						stageFront.scrollFactor.set(0.9, 0.9);
						...
						var fg:FlxSprite = new FlxSprite(-600, -500).loadGraphic(Paths.image('artshelf'));
						fg.updateHitbox();
